...
```{r, message=FALSE}
mr_trash_wheel <- read_excel("hw2_data/202309 Trash Wheel Collection Data.xlsx", 
...
```{r}
prof_trash_wheel <- read_excel("hw2_data/202309 Trash Wheel Collection Data.xlsx", 
...
```{r}
gwynnda_trash_wheel <- read_excel("hw2_data/202309 Trash Wheel Collection Data.xlsx", 
